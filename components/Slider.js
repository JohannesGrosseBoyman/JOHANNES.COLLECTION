...
const slides = [
  {
    id: 1,
    title: "Amazing Slippers",
    description: "Treat your feets nicely!",
  ...
  {
    id: 2,
    title: "Handbags for every occasion",
    description: "Everything important always at hand!",
    img: "/bag_yellow.jpg",
  ...
  {
    id: 3,
    title: "Accessories that make you feel great",
        ...
        {slides.map((slide) => (
          ...
          >
            ...
            <div className="h-1/2 xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 2xl:gap-16">
              ...
              <Link href={slide.url}>
                <button className="rounded-md bg-primary text-white px-4 py-3">
                  SHOP NOW
                </button>
              </Link>
            </div>
